...
function CommentSection ({likes, comments, retweets, share}:CommentSectionProps){
    return(
        <div className="flex flex-row gap-10">
            ...
            <CommentSectionContent src="/logo/comment.svg" text={comments} className="flex flex-row w-1/4 items-center gap-3 font-extralight text-gray-500 hover:text-blue-700 hover:cursor-pointer"/>
